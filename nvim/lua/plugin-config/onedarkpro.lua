local ok_onedarkpro, onedarkpro = pcall(require, "onedarkpro")

if not ok_onedarkpro then
    vim.notify("[ERROR] Don't find the plugin 'onedarkpro', please check 'plugins.lua'.")
  return
end
